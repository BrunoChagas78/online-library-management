...
Se você quiser, no próximo passo eu posso **adaptar esse texto** para o modelo exato que o professor passou (se tiver capa, tabela, etc.), é só colar aqui o enunciado do modelo ou reenviar o último DOC/PDF de especificação.
